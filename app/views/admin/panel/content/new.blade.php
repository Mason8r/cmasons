...
<div class="row">
	<div class="col-sm-8">
		...
		{{ Form::open(array('url' => 'admin/content/'.(isset($content) ? 'edit/'.$content->id : 'new') , 'role' => 'form')) }}
		...
		<div class="form-group new-menu" id="new-menu" style="display: none;">
		...
		<div class="form-group">
		    ...
		    {{ Form::textarea('content', (isset($content->slug) ? $content->slug : ''), array('class' => 'form-control') ) }}
...
$( document ).ready(function() {
    //toggle the unrequired sections
